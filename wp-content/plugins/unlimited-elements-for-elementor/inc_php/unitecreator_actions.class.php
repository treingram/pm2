		...
		try{
			...
			switch($action){
				...
				case "install_catalog_page":
					...
					HelperUC::ajaxResponseSuccess(esc_html__("Template Installed", "unlimited_elements"), $arrResponse);
				break;
				...
				case "import_elementor_catalog_template":
					...
					HelperUC::ajaxResponseSuccess(esc_html__("Template Imported", "unlimited_elements"), $arrResponse);
