	...
	private function runValidation($validation){
		...
		switch($validation){
			case self::VALIDATION_PREVIEW_EXISTS:
				...
				if($isExists == false)
					$this->arrMessages[] = __("Missing Preview Link","unlimited_elements");
