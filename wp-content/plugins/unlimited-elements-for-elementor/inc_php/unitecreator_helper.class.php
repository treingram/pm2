 ...
 */
	class HelperUC extends UniteHelperBaseUC{
		...
		public static function validateDBTablesExists(){
			...
			if($db->isTableExists(GlobalsUC::$table_categories) == false)
				UniteFunctionsUC::throwError("Categories table not exists");
			
			if($db->isTableExists(GlobalsUC::$table_addons) == false)
				UniteFunctionsUC::throwError("Widgets table not exists");
