...
class UniteCreatorManagerAddonsWork extends UniteCreatorManager{
	...
	private function putDialogImportAddons(){
		...
		if($this->isLayouts == true){
			$textOverwrite = esc_html__("Overwrite Widgets", "unlimited_elements");
		...
		<div id="uc_dialog_preview_template" class="uc-dialog-preview-template unite-inputs<?php echo $addClass?>" title="<?php echo esc_attr($dialogTitle)?>" style="display:none;">
				...
				<div class="uc-dialog-preview-template__right">
					...
					<div class="uc-dialog-preview-template__right-operations">
						...
						<a href="javascript:void(0)" class="unite-button-primary uc-dialog-preview-template__button-import uc-show-when-new uc-hide-when-loading uc-hide-when-just-imported"><?php _e("Import Template","unlimited_elements")?></a>
						<a href="javascript:void(0)" class="unite-button-primary uc-dialog-preview-template__button-import-again uc-show-when-imported uc-hide-when-loading uc-hide-when-just-imported" data-message-confirm="<?php echo $confirmImportAgainMessage?>" ><?php _e("Import Template Again","unlimited_elements")?></a>
						...
						<div class="uc-dialog-preview-template__create-page-wrapper">
							...
							<div class="uc-dialog-preview-template__import-page-wrapper">
								...
								<a href="javascript:void(0)" class="unite-button-secondary uc-dialog-preview-template__button-create-page uc-disable-when-loading"><?php _e("Create Page","unlimited_elements")?></a>
